...
| github_release | OggPoW | https://github.com/Oggcoin/OggPoW-Miner/releases.atom |
...
| github_search | Oggchain GPU mining created:>{since} | https://api.github.com/search/repositories?q=Oggchain GPU mining created:>{since} |
