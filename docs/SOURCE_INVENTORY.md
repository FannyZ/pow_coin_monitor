...
| github_release | Ogg Node | https://github.com/Oggcoin/Ogg-Node/releases.atom |
...
| github_search | Oggchain mainnet created:>{since} | https://api.github.com/search/repositories?q=Oggchain mainnet created:>{since} |
