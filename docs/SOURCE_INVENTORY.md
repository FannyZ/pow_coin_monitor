...
| github_release | Oggchain | https://github.com/Oggchain/Oggchain/releases.atom |
| github_release | OggPoW Miner | https://github.com/Oggchain/OggPoW-Miner/releases.atom |
...
| github_search | Gaelium mainnet created:>{since} | https://api.github.com/search/repositories?q=Gaelium mainnet created:>{since} |
| github_search | OggPoW created:>{since} | https://api.github.com/search/repositories?q=OggPoW created:>{since} |
| github_search | QSDM GPU mining created:>{since} | https://api.github.com/search/repositories?q=QSDM GPU mining created:>{since} |
| github_search | Malairte created:>{since} | https://api.github.com/search/repositories?q=Malairte created:>{since} |
| github_search | FusionHash created:>{since} | https://api.github.com/search/repositories?q=FusionHash created:>{since} |
