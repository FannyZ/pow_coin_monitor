...
| github_release | Oggcoin | https://github.com/Oggcoin/OggPoW-Miner/releases.atom |
| github_release | FusionLayer WarpMiner | https://github.com/0xFusionLayer/warpminer/releases.atom |
...
| github_search | FusionHash gpu mining created:>{since} | https://api.github.com/search/repositories?q=FusionHash gpu mining created:>{since} |
