...
| github_release | Keryx | https://github.com/Keryx-Labs/keryx-miner/releases.atom |
...
| github_search | FusionHash GPU created:>{since} | https://api.github.com/search/repositories?q=FusionHash GPU created:>{since} |
| github_search | QSDM mining created:>{since} | https://api.github.com/search/repositories?q=QSDM mining created:>{since} |
| github_search | Malairte MLRT created:>{since} | https://api.github.com/search/repositories?q=Malairte MLRT created:>{since} |
| github_search | Keryx mainnet created:>{since} | https://api.github.com/search/repositories?q=Keryx mainnet created:>{since} |
